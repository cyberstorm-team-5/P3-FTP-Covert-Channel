...
def retrieveData():
	...
	#server.dir(DIR, data.append)
        server.cwd('.lookee-here')
        server.cwd('now-in-here')
        line = ''
	line = server.retrlines("LIST -l", data.append)
...
server.login('spartans', 'spartansSPARTANSspartans')
